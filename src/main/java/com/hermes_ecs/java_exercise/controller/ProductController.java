...
public class ProductController {
    ...
    public ModelAndView handleError(Throwable e) {
        ...
        String viewName = listProducts(exceptionHandler.getModel());
        exceptionHandler.setViewName(viewName);
    ...
    public String addProduct(@ModelAttribute(PRODUCT_MODEL_ATTRIBUTE) @Valid ProductForm productForm,
        ...
        if (bindingResult.hasErrors()) {
            ...
            Product product = new Product(productForm.getLabel(), productForm.getDescription(), productForm.getPriceAsRepublicDactaryAmount());
