...
public abstract class ProductMother {
    ...
    public static Product landSpeeder() {
        return new Product(LANDSPEEDER_X34, LANDSPEEDER_X34_DESCRIPTION, LANDSPEEDER_X34_PRICE);
    }

    public static Product t47Airspeeder() {
        return new Product(T47_AIRSPEEDER, T47_AIRSPEEDER_DESCRIPTION, T47_AIRSPEEDER_PRICE);
    }
}
