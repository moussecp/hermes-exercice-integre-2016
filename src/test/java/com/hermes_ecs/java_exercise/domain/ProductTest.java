...
public class ProductTest {
    ...
    @Before
    public void setup() {
        firstProduct = new Product(LABEL, DESCRIPTION, PRICE);
        secondProduct = new Product(LABEL + "delta", DESCRIPTION + "delta",
                PRICE);
    }
    ...
    public void constructorWithNullPriceThrowsAnException() {
        new Product(LABEL, DESCRIPTION, null);
    }
